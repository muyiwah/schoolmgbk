class FeeBreakdownResponse {
  ...
  factory FeeBreakdownResponse.fromJson(Map<String, dynamic> json) {
    return FeeBreakdownResponse(
      ...
      data: FeeBreakdownData.fromJson(json['data'] ?? {}),
    );
  }
...
class FeeBreakdownData {
  ...
  factory FeeBreakdownData.fromJson(Map<String, dynamic> json) {
...
class PaymentStatistics {
  ...
  factory PaymentStatistics.fromJson(Map<String, dynamic> json) {
    return PaymentStatistics(
      ...
      totalAmountLeft: (json['totalAmountLeft'] ?? 0).toDouble(),
